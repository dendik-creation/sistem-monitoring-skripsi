...
class MahasiswaController extends Controller
{
    ...
    {
        //[Syahrul][30/04/2025]Pembenahan query dengan melewati pencarian gelar jika dosping tidak ditemukan
        $user = Auth::user();
        $dosen1 = null;
        $dosen2 = null;
        $data = PlotDosbingModel::where('nim', $user->no_induk)->first();
        if ($data) {
    ...
    public function viewPengajuanProposal()
    {
        ...
        $data = DB::table('proposal')
            ...
            ->select(
                ...
                'proposal.id as id',
                'semester.semester as smt',
                'semester.tahun as thn',
                'proposal.nim as nim',
    ...
    public function viewDaftarSempro()
    {
        ...
        $data = DB::table('berkas_sempro')
            ...
            ->select(
                ...
                'mahasiswa.hp as hp',
                'proposal.judul as judul',
                'mahasiswa.status_sempro as status_sempro',
                'plot_dosbing.dosbing1 as dosbing1',
                'plot_dosbing.dosbing2 as dosbing2',
                'berkas_sempro.*',
    ...
    public function formAddBimbingan()
    {
        ...
        $data = DB::table('plot_dosbing')
            ...
            ->select(
                ...
                's32.depan as depan2',
                's31.depan as depan1',
                'plot_dosbing.dosbing1 as nidn1',
                'plot_dosbing.dosbing2 as nidn2'
            )
            ->where('nim', $user->no_induk)->first();
    ...
    public function viewBimbinganDetail($id)
    {
        ...
        $pesan = DB::table('pesan_bimbingan')
            ...
            ->select(
                'pesan_bimbingan.id as id',
                'pesan_bimbingan.pesan as pesan',
                'pesan_bimbingan.id_user as id_user',
                'users.name as name',
                'pesan_bimbingan.created_at as waktu',
