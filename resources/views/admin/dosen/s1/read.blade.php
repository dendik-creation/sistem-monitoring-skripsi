...
@section('content')
    <div class="container-fluid mt-4">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Data Gelar S1</h1>
            <div class="pull-right">
                <a href="/admin/dosen/s1/tambah" class="btn btn-success btn-flat">
                            ...
                            <?php $no=1?>
                              @foreach($data as $item)
                                <tr>
                                    ...
                                    <td>{{ $item -> gelar }}</td>
                                    <td>
                                        <a href="/admin/dosen/s1/edit/{{$item->id}}" class="btn btn-primary btn-sm">Edit</a>
                                    </td>
                                    {{-- <td>
