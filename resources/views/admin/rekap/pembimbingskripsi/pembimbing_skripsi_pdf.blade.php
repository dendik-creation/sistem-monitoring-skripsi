...
<body>
  ...
  <div style="position: absolute; left: 84px; top: 230px" class="cls_005"><span class="cls_005"><b>: Permohonan SK Pembimbing Skripsi</b></span></div>
  ...
  <div style="position: absolute; left: 85px; top: 375px; width: 191px;" class="cls_005"><span class="cls_005"><b>Universitas Muria Kudus</b></span></div>
	...
	<div style="position: absolute; left: 86px; top: 430px; line-height: 160%;" class="cls_005"><span class="cls_005">Sehubungan dengan dilaksanakannya Kegiatan Seminar Proposal Periode <?= ucfirst(strtolower($smt->semester))?> {{ $smt->tahun }} di Program Studi Teknik Informatika, bersama surat ini kami mengajukan permohonan agar dapat dibuatkan SK untuk Dosen Pembimbing Skripsi. Adapun daftar nama dosen dan nama mahasiswa terlampir.</span></div> 
