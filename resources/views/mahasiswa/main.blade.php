...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item {{ Request::is('mahasiswa/proposal/*') ? 'active' : ''}}">
            ...
            <!-- Nav Item -->
            <li class="nav-item {{ Request::is('mahasiswa/skripsi/*') ? 'active' : ''}}">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('dataskripsi') }}">Status Skripsi</a>
                        <a class="collapse-item" href="{{ route('databimbingan') }}">Bimbingan Skripsi</a>
                        <a class="collapse-item" href="{{ route('datadaftarujian') }}">Daftar Ujian</a>
                        <a class="collapse-item" href="{{ route('datahasilujianmhs') }}">Hasil Ujian</a>
                    </div>
                </div>
            </li>
