...
@section('content')
    <div class="container-fluid mt-4">
                ...
                <div class="row">
                    ...
                    <div class="dropdown mr-2">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuOffset">
                          ...
                          <a class="dropdown-item" href="/mahasiswa/skripsi/bimbingan/tambah/2">Bimbingan Ke Dosen Pembimbing Pembantu</a>
                        </div>
                    </div>
                    <a href="/mahasiswa/skripsi/bimbingan/tampil" class="btn btn-outline-success btn-flat">
                        Rekap Bimbingan
                    </a>
                </div>
        ...
        <ul class="nav nav-tabs mt-5">
            ...
            <li class="nav-item">
              <a data-toggle="tab" class="nav-link h6" href="#dosen2">Dosen Pembimbing Pembantu</a>
            </li>
          </ul>
