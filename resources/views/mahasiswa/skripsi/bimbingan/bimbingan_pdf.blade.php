...
<body class="A5">
  ...
  <div style="position:absolute;left:50%;margin-left:-306px;top:-30px;width:612px;height:1008px;overflow:hidden">
    <div style="position: absolute; left: 15px; top: 27px"></div>
    <div style="position: absolute; left: 80px; top: 44px; letter-spacing: 0.1em; text-align:center" class="cls_004"><span class="cls_004"><b>RIWAYAT BIMBINGAN SKRIPSI/TUGAS AKHIR</b></span></div>
      <div style="position: absolute; left: 133px; top: 85px; letter-spacing: 0.1em;" class="cls_005"><span class="cls_004"><b>PROGRAM STUDI TEKNIK INFORMATIKA</b></span></div>
	  <div style="position: absolute; left: 218px; top: 114px; letter-spacing: 0.1em;" class="cls_005"><span class="cls_004"><b>FAKULTAS TEKNIK</b></span></div>
	  <div style="position: absolute; left: 179px; top: 144px; letter-spacing: 0.1em;" class="cls_005"><span class="cls_004"><b>UNIVERSITAS MURIA KUDUS</b></span></div>
	  <div style="position: absolute; left: 248px; top: 184px; width: 115px; height: 115px;">
        <img src="{{  url('logo.png') }}" width=113 height=113>
    </div>
...
@endif</span></div>
  <div style="position: absolute; left: 80px; top: 432px; width: 191px;" class="cls_005"><span class="cls_005"><b>Pembimbing Pembantu</b></span></div>
	  <div style="position: absolute; left: 249px; top: 432px" class="cls_005"><span class="cls_005">: @if ($dosen2==null)
      -
  @else
  @if ($dosen2 -> depan == "Y")
...
<div style="position:absolute; left:50%;margin-left:-306px;top:730px;width:612px;height:auto;">
