...
@section('content')
    <div class="container-fluid mt-4">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-2 text-gray-800">Tambah Bimbingan Ke Dosen Pembimbing Pembantu</h1>
        </div>
        ...
        {{-- Form --}}
        <form class="user" action="/mahasiswa/insertbimbingan/2" method="POST" enctype="multipart/form-data">
            <div class="row mt-2">
                {{csrf_field()}}
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        @php
                            ...
                            ->where('bimbingan.bimbingan_kepada', $data->nidn2)
