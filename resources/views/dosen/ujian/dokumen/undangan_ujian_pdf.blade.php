...
<div style="position: absolute; left: 206px; top: 240px" class="cls_005"><span class="cls_005">{{ $dosen1->gelar3 }} {{ $dosen1->name }}, {{ $dosen1->gelar1 }}, {{ $dosen1->gelar2 }} - {{ $dosen2->gelar3 }} {{ $dosen2->name }}, {{ $dosen2->gelar1 }}, {{ $dosen2->gelar2 }}</span></div>
...
<div style="position: absolute; left: 198px; top: 319px" class="cls_005"><span class="cls_005">: {{ $ketua->gelar3 }} {{ $ketua->name }}, {{ $ketua->gelar1 }}, {{ $ketua->gelar2 }}</span></div>
<div style="position: absolute; left: 38px; top: 349px" class="cls_005"><span class="cls_005">Anggota Penguji 1</span></div>
<div style="position: absolute; left: 198px; top: 349px" class="cls_005"><span class="cls_005">: {{ $anggota1->gelar3 }} {{ $anggota1->name }}, {{ $anggota1->gelar1 }}, {{ $anggota1->gelar2 }}</span></div>
<div style="position: absolute; left: 38px; top: 379px;" class="cls_005"><span class="cls_005">Anggota Penguji 2</span></div>
<div style="position: absolute; left: 198px; top: 379px" class="cls_005"><span class="cls_005">: {{ $anggota2->gelar3 }} {{ $anggota2->name }}, {{ $anggota2->gelar1 }}, {{ $anggota2->gelar2 }}</span></div>
