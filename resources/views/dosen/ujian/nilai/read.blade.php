...
@section('content')
    <div class="container-fluid mt-4">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Nilai Ujian Skripsi</h1>
                            ...
                            <?php $no=1?>
                              @foreach($data as $item)
                                <tr>
                                    ...
                                    <td>
                                        @if ($item->ketua_penguji == $user->no_induk)
                                            @if( $item->sikap1==null )
                                            -
                                            @else
                                            {{ $item->sikap1 }}
                                            @endif
                                        @elseif($item->anggota_penguji_1 == $user->no_induk)
                                            @if( $item->sikap2==null )
                                            -
                                            @else
                                            {{ $item->sikap2 }}
                                            @endif
                                        @elseif($item->anggota_penguji_2 == $user->no_induk)
                                            @if( $item->sikap3==null )
                                            -
                                            @else
                                            {{ $item->sikap3 }}
                                    ...
                                    <td>
                                        @if ($item->ketua_penguji == $user->no_induk)
                                            @if( $item->presentasi1==null )
                                            -
                                            @else
                                            {{ $item->presentasi1 }}
                                            @endif
                                        @elseif($item->anggota_penguji_1 == $user->no_induk)
                                            @if( $item->presentasi2==null )
                                            -
                                            @else
                                            {{ $item->presentasi2 }}
                                            @endif
                                        @elseif($item->anggota_penguji_2 == $user->no_induk)
                                            @if( $item->presentasi3==null )
                                            -
                                            @else
                                            {{ $item->presentasi3 }}
                                            @endif
                                    ...
                                    <td>
                                        @if ($item->ketua_penguji == $user->no_induk)
                                            @if( $item->jumlah1==null )
                                            -
                                            @else
                                            {{ $item->jumlah1 }}
                                            @endif
                                        @elseif($item->anggota_penguji_1 == $user->no_induk)
                                            @if( $item->jumlah2==null )
                                            -
                                            @else
                                            {{ $item->jumlah2 }}
                                            @endif
                                        @elseif($item->anggota_penguji_2 == $user->no_induk)
                                            @if( $item->jumlah3==null )
                                            -
                                            @else
                                            {{ $item->jumlah3 }}
                                            @endif
                                    ...
                                    <td><a href="/dosen/skripsi/hasil/detail/{{ $item->id }}" class="btn btn-primary btn-sm">Lihat detail</a></td>
                                </tr>
                           @endforeach
                        </tbody>
                    </table>
