    ...
    <div class="container-fluid mt-4">
        ...
        <ul class="nav nav-tabs mt-5">
          <li class="nav-item active">
            <a data-toggle="tab" class="nav-link h6 <?=$item->dosbing1==$user->no_induk ? 'active' : 'disabled'?>" href="#dosen1">Dosen Pembimbing Utama</a>
          </li>
          <li class="nav-item">
            <a data-toggle="tab" class="nav-link h6 <?=$item->dosbing2==$user->no_induk ? 'active' : 'disabled'?>" href="#dosen2">Dosen Pembimbing Pembantu</a>
          </li>
        </ul>
                ...
                <table class="table table-borderless">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>:</td>
                            <th><input type="number" class="form-control" id="semprosikap1" name="sikap1" onkeyup="sempro1()"  placeholder="Masukkan Nilai Sikap" <?=$item->dosbing1==$user->no_induk ? '' : 'disabled'?>></th>
                          </tr>
                          <tr>
                            <td>Nilai Presentasi(30%) (1-100)</td>
                            <td>:</td>
                            <th><input type="number" class="form-control" id="sempropresentasi1" name="presentasi1" onkeyup="sempro1()" placeholder="Masukkan Nilai Presentasi" <?=$item->dosbing1==$user->no_induk ? '' : 'disabled'?>></th>
                          </tr>
                          <tr>
                            <td>Nilai Penguasaan Teori(50%) (1-100)</td>
                            <td>:</td>
                            <th><input type="number" class="form-control" id="sempropenguasaan1" name="penguasaan1" onkeyup="sempro1()" placeholder="Masukkan Nilai Penguasaan Teori" <?=$item->dosbing1==$user->no_induk ? '' : 'disabled'?>></th>
                          </tr>
                          <tr>
                            <td>Jumlah* (1-100)</td>
                            <td>:</td>
                            <th><input type="number" class="form-control" id="semprojumlah1" name="jumlah1" placeholder="Masukkan Jumlah" required <?=$item->dosbing1==$user->no_induk ? '' : 'disabled'?>></th>
                          </tr>
                          <tr>
                            <td><hr class="sidebar-divider"></td>
                            <td></td>
                ...
                <table class="table table-borderless">
                        <tbody>
                          <tr>
                            <td>Nilai Sikap(20%) (1-100)</td>
                            <td>:</td>
                            <th><input type="number" class="form-control" id="semprosikap2" name="sikap2" onkeyup="sempro2()" placeholder="Masukkan Nilai Sikap" <?=$item->dosbing2==$user->no_induk ? '' : 'disabled'?>></th>
                          </tr>
                          <tr>
                            <td>Nilai Presentasi(30%) (1-100)</td>
                            <td>:</td>
                            <th><input type="number" class="form-control" id="sempropresentasi2" name="presentasi2" onkeyup="sempro2()" placeholder="Masukkan Nilai Presentasi" <?=$item->dosbing2==$user->no_induk ? '' : 'disabled'?>></th>
                          </tr>
                          <tr>
                            <td>Nilai Penguasaan Teori(50%) (1-100)</td>
                            <td>:</td>
                            <th><input type="number" class="form-control" id="sempropenguasaan2" name="penguasaan2" onkeyup="sempro2()" placeholder="Masukkan Nilai Penguasaan Teori" <?=$item->dosbing2==$user->no_induk ? '' : 'disabled'?>></th>
                          </tr>
                          <tr>
                            <td>Jumlah* (1-100)</td>
                            <td>:</td>
                            <th><input type="number" class="form-control" id="semprojumlah2" name="jumlah2" placeholder="Masukkan Jumlah" required <?=$item->dosbing2==$user->no_induk ? '' : 'disabled'?>></th>
                          </tr>
                          <tr>
                            <td><hr class="sidebar-divider"></td>
                            <td></td>
