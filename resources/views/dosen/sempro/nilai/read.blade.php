...
@section('content')
    <div class="container-fluid mt-4">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Nilai Seminar Proposal</h1>
                            ...
                            <?php $no=1?>
                              @foreach($data as $item)
                                <tr>
                                    ...
                                    <td>
                                        @if ($item->dosbing1 == $user->no_induk)
                                            @if( $item->penguasaan1==null )
                                            -
                                            @else
                                            {{ $item->penguasaan1 }}
                                            @endif
                                        @else
                                            @if( $item->penguasaan2==null )
                                            -
                                            @else
                                            {{ $item->penguasaan2 }}
                                            @endif
                                    ...
                                    <td><a href="/dosen/sempro/hasil/detail/{{ $item->id }}" class="btn btn-primary btn-sm">Lihat detail</a></td>
                                </tr>
                           @endforeach
                        </tbody>
                    </table>
